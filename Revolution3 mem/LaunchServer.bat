...
echo Launching forge-1.7.10-10.13.4.1614-1.7.10-universal.jar with '%mem%' max memory, jvm args '%jvmargs%' and arguments '%launchargs%'

:: add nogui to the end of this line to disable the gui ::
"%javapath%" -Xmx%mem% %jvm_args%  -Dlog4j2.formatMsgNoLookups=true -Dlog4j.configurationFile=log4j2.xml -jar forge-1.7.10-10.13.4.1614-1.7.10-universal.jar %launchargs%
PAUSE
