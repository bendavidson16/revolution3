...
echo "Launching forge-1.7.10-10.13.4.1614-1.7.10-universal.jar with '$MEMORY' max memory, jvm args '$JVMARGS' and arguments '$LAUNCHARGS'"

$JAVAPATH -Xmx$MEMORY $JVMARGS  -Dlog4j2.formatMsgNoLookups=true -Dlog4j.configurationFile=log4j2.xml -jar forge-1.7.10-10.13.4.1614-1.7.10-universal.jar "$LAUNCHARGS"
